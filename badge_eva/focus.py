...
#
# focus.py : v3.1-refactor 0.7.2 (Operational release!)
...
# Draw the end screen with restart button
def draw_end_screen():
    #display.update_speed(badger2040.UPDATE_FAST)
    display.led(128)
    display.pen(15)
...
def draw_focus_setting4():
    ...
    # duration indicator
    #display.pen(0)
    #graphics.fill_rect(241, 24, 13, 11)
    #graphics.rect(252, 24, 13, 11)
    #display.pen(15)
    #display.thickness(1)
    #display.font("bitmap8")
    #display.text("12", 244, 26, 0.1)
    #display.pen(0)
    #display.text("2", 257, 26, 0.1)
